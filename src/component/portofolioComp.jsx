...
function PortofolioComp({lightMode,showMenu,isMobile}) {
  ...
  function PortofolioComponent({ lightMode, showMenu, isMobile }) {
    return (
      <>
        <div
          className={`profile flex columns mx-auto container h-fit w-[80%] flex-shrink`}
        >
          <div
  ...
  return (
    <>
    <PortofolioComponent lightMode={lightMode}
        isMobile={isMobile}
        showMenu={showMenu}/>
    </>
  );
